# generated timestamp: 2022-12-16T07:17:27+00:00
...
from .ProductShema import WishCreateProduct
...
@router.post(
    '/merchant/product/wish/{store_id}/createproduct',
    response_class=XTJsonResponse,
    response_model=CommonResponse,
)
async def createproduct(
    store_id: int,
    body: WishCreateProduct,
    ...
    ret = await Service.wishService.createProduct(db, store, body)
