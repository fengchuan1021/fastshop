...
class PurchaseReceipt(Base):
    ...
    Supplier: 'Supplier' = relationship('Supplier', uselist=False,
    ...
    PurchaseReceiptItems: List['PurchaseReceiptItems'] = relationship('PurchaseReceiptItems',
                                                                      ...
                                                                      uselist=True, back_populates='PurchaseReceipt',
                                                                      cascade=''
                                                                      )
...
class PurchaseReceiptItems(Base):
    ...
    totalamount = Column(DECIMAL(10, 2), default='0', server_default='0', comment='number*price')

    PurchaseReceipt: 'PurchaseReceipt' = relationship('PurchaseReceipt',
                                                      primaryjoin='foreign(PurchaseReceiptItems.purchase_receipt_id)==PurchaseReceipt.purchase_receipt_id',
                                                      uselist=False, back_populates='PurchaseReceiptItems', cascade=''
                                                      )
    Variant: 'Variant' = relationship('Variant',
                                                      primaryjoin='foreign(PurchaseReceiptItems.purchase_receipt_id)==Variant.variant_id',
                                                      uselist=False, back_populates='PurchaseReceiptItems', cascade=''
                                                      )
